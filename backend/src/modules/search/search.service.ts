...
export class SearchService {
  ...
  async search(
    ...
    console.log(
      `[search] original="${query}" preprocessed="${preprocessed}" intent=${analysis.intent} uni=${analysis.universityCode || 'none'}`,
    );
    ...
    console.log(
      `[search] strategy=${transformed.strategy}, variants=${transformed.variants.length}`,
    );
