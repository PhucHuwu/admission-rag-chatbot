...
const universities = [
  {
    url: 'https://diemthi.tuyensinh247.com/de-an-tuyen-sinh/dai-hoc-y-ha-noi-YHB.html',
    label: 'YHB - Y Ha Noi',
  },
  {
    url: 'https://diemthi.tuyensinh247.com/de-an-tuyen-sinh/dai-hoc-su-pham-ha-noi-SPH.html',
    label: 'SPH - Su Pham Ha Noi',
  },
  {
    url: 'https://diemthi.tuyensinh247.com/de-an-tuyen-sinh/dai-hoc-bach-khoa-hcm-QSB.html',
    label: 'QSB - Bach Khoa HCM',
  },
  {
    url: 'https://diemthi.tuyensinh247.com/de-an-tuyen-sinh/dai-hoc-cong-nghe-dai-hoc-quoc-gia-ha-noi-QHI.html',
    label: 'QHI - Cong Nghe QGHN',
  },
  {
    url: 'https://diemthi.tuyensinh247.com/de-an-tuyen-sinh/dai-hoc-ngoai-thuong-co-so-phia-bac-NTH.html',
    label: 'NTH - Ngoai Thuong',
  },
];
